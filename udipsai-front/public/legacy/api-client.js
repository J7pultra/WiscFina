  ...
  invoke: async (channel, data = {}) => {
    try {
      ...
      const routeMap = {
        ...
        'api:evaluaciones:guardar': { url: '/api/evaluaciones', method: 'POST' },
        'api:evaluaciones:buscar': { url: '/api/evaluaciones/buscar', method: 'POST' },
        'api:evaluaciones:eliminar': { url: `/api/evaluaciones/${data.id}`, method: 'DELETE', omitBody: true },
        'api:evaluaciones:leer': { url: `/api/evaluaciones/${data.id}`, method: 'GET', omitBody: true },
        'api:leer:logo:base64': { url: '/ucacue_b64.txt', method: 'GET', omitBody: true },
